...
export default function AuthError({
  ...
  return (
    <main className="relative flex min-h-dvh flex-1 flex-col items-center justify-center gap-4 px-6 py-12">
      <div
        aria-hidden
        className="pointer-events-none absolute -top-24 -left-24 h-72 w-72 rounded-full bg-red/10 blur-3xl"
      />
      <h2 className="font-name text-2xl text-white">Something went wrong</h2>
